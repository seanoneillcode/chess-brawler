...
public class BoardManager {
    ...
    void createPieces(ChessBrawler context) {
        ...
        pieces.add(new Piece(new Vector2(TILE_SIZE, 0), new Vector2(), PieceType.CASTLE, KNIGHT_IDLE, RED));
        pieces.add(new Piece(new Vector2(TILE_SIZE * 2, 0), new Vector2(), PieceType.CASTLE, BISHOP_IDLE, RED));
        pieces.add(new Piece(new Vector2(TILE_SIZE * 3, 0), new Vector2(), PieceType.CASTLE, QUEEN_IDLE, RED));
        pieces.add(new Piece(new Vector2(TILE_SIZE * 4, 0), new Vector2(), PieceType.CASTLE, KING_IDLE, RED));
        pieces.add(new Piece(new Vector2(TILE_SIZE * 5, 0), new Vector2(), PieceType.CASTLE, BISHOP_IDLE, RED));
        pieces.add(new Piece(new Vector2(TILE_SIZE * 6, 0), new Vector2(), PieceType.CASTLE, KNIGHT_IDLE, RED));
        ...
        pieces.add(new Piece(new Vector2(TILE_SIZE, TILE_SIZE * 7), new Vector2(), PieceType.CASTLE, KNIGHT_IDLE, BLUE));
        pieces.add(new Piece(new Vector2(TILE_SIZE * 2, TILE_SIZE * 7), new Vector2(), PieceType.CASTLE, BISHOP_IDLE, BLUE));
        pieces.add(new Piece(new Vector2(TILE_SIZE * 3, TILE_SIZE * 7), new Vector2(), PieceType.CASTLE, KING_IDLE, BLUE));
        pieces.add(new Piece(new Vector2(TILE_SIZE * 4, TILE_SIZE * 7), new Vector2(), PieceType.CASTLE, QUEEN_IDLE, BLUE));
        pieces.add(new Piece(new Vector2(TILE_SIZE * 5, TILE_SIZE * 7), new Vector2(), PieceType.CASTLE, BISHOP_IDLE, BLUE));
        pieces.add(new Piece(new Vector2(TILE_SIZE * 6, TILE_SIZE * 7), new Vector2(), PieceType.CASTLE, KNIGHT_IDLE, BLUE));
