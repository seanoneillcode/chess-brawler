...
public class BoardManager {
    ...
    void createPieces(ChessBrawler context) {
        ...
        pieces.add(new Piece(new Vector2(TILE_SIZE * 3, 0), new Vector2(), PieceType.QUEEN, QUEEN_IDLE_RED, RED, QUEEN_IDLE_RED, QUEEN_DIE_RED));
        ...
        pieces.add(new Piece(new Vector2(TILE_SIZE * 4, TILE_SIZE * 7), new Vector2(), PieceType.QUEEN, QUEEN_IDLE, BLUE, QUEEN_IDLE, QUEEN_DIE));
