...
public class BoardManager {
    ...
    void createPieces(ChessBrawler context) {
        ...
        pieces.add(new Piece(new Vector2(0, 0), new Vector2(), PieceType.CASTLE, CASTLE_IDLE, RED, CASTLE_WALK, CASTLE_DIE));
        pieces.add(new Piece(new Vector2(TILE_SIZE, 0), new Vector2(), PieceType.KNIGHT, KNIGHT_IDLE, RED, KNIGHT_WALK, KNIGHT_DIE));
        pieces.add(new Piece(new Vector2(TILE_SIZE * 2, 0), new Vector2(), PieceType.BISHOP, BISHOP_IDLE, RED, BISHOP_WALK, BISHOP_DIE));
        pieces.add(new Piece(new Vector2(TILE_SIZE * 3, 0), new Vector2(), PieceType.QUEEN, QUEEN_IDLE, RED, QUEEN_IDLE, QUEEN_IDLE));
        pieces.add(new Piece(new Vector2(TILE_SIZE * 4, 0), new Vector2(), PieceType.KING, KING_IDLE, RED, KING_WALK, KING_DIE));
        pieces.add(new Piece(new Vector2(TILE_SIZE * 5, 0), new Vector2(), PieceType.BISHOP, BISHOP_IDLE, RED, BISHOP_WALK, BISHOP_DIE));
        pieces.add(new Piece(new Vector2(TILE_SIZE * 6, 0), new Vector2(), PieceType.KNIGHT, KNIGHT_IDLE, RED, KNIGHT_WALK, KNIGHT_DIE));
        pieces.add(new Piece(new Vector2(TILE_SIZE * 7, 0), new Vector2(), PieceType.CASTLE, CASTLE_IDLE, RED, CASTLE_WALK, CASTLE_DIE));
